    ...
    public class MovieDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>().HasData(
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000001"), Title = "Die Hard", GenreId = 1, MediumTypeCode = "DVD", Price = 9.99M, ReleaseDate = new DateTime(1988, 7, 15), Rating = Ratings.Good },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000002"), Title = "Mad Max: Fury Road", GenreId = 1, MediumTypeCode = "BD", Price = 14.99M, ReleaseDate = new DateTime(2015, 5, 15), Rating = Ratings.Excellent },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000003"), Title = "Groundhog Day", GenreId = 2, MediumTypeCode = "DVD", Price = 7.99M, ReleaseDate = new DateTime(1993, 2, 12), Rating = Ratings.Bad },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000004"), Title = "The Grand Budapest Hotel", GenreId = 2, MediumTypeCode = "BD", Price = 12.99M, ReleaseDate = new DateTime(2014, 3, 28), Rating = Ratings.Average },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000005"), Title = "The Shawshank Redemption", GenreId = 3, MediumTypeCode = "DVD", Price = 8.99M, ReleaseDate = new DateTime(1994, 9, 23), Rating = Ratings.Bad },
                ...
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000007"), Title = "The Shining", GenreId = 4, MediumTypeCode = "DVD", Price = 9.99M, ReleaseDate = new DateTime(1980, 5, 23), Rating = Ratings.Good },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000008"), Title = "A Quiet Place", GenreId = 4, MediumTypeCode = "STREAM", Price = 4.99M, ReleaseDate = new DateTime(2018, 4, 6), Rating = Ratings.Average },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000009"), Title = "Blade Runner", GenreId = 5, MediumTypeCode = "BD", Price = 13.99M, ReleaseDate = new DateTime(1982, 6, 25), Rating = Ratings.Average },
                new Movie { Id = Guid.Parse("00000000-0000-0000-0000-000000000010"), Title = "The Matrix", GenreId = 5, MediumTypeCode = "DVD", Price = 10.99M, ReleaseDate = new DateTime(1999, 3, 31), Rating = Ratings.Good }
            );
